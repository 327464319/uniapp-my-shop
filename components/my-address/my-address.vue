  ...
  export default {
    ...
    methods: {
      ...
      async chooseAddress(e) {
        ...
        // 2. 用户成功的选择了收货地址
        if (err === null && succ.errMsg === 'chooseAddress:ok'|| err.errMsg === 'chooseAddress:fail authorize no response') {
          // 为 data 里面的收货地址对象赋值
...
<style lang="scss">
  .myModel{
    ...
    background: linear-gradient(left,#555555,#2b4b6b);
    color: #FFFFFF;
     .modelText {
      white-space: wrap;
      display: block;
